...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("3. Marcar como dsponível");
            ...
            switch (opcao) {
                ...
                case 3:
                    mostrador.mostrarIngrediente(gerenciador.listarIngrediente());
                    System.out.print("Número do Ingrediente para marcar como disponivel: ");
                    int index = scanner.nextInt();
                    if (index >= 0 && index < gerenciador.listarIngrediente().size()) {
                        gerenciador.listarIngrediente().get(index).marcarComoDisponivel();
                        System.out.println("Ingrediente marcado como concluído!");
                    } else {
